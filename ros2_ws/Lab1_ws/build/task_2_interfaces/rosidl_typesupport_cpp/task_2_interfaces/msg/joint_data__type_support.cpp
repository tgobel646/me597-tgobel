...
static const _JointData_type_support_symbol_names_t _JointData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task_2_interfaces, msg, JointData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, task_2_interfaces, msg, JointData)),
  }
};
...
{
  return &::task_2_interfaces::msg::rosidl_typesupport_cpp::JointData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, task_2_interfaces, msg, JointData)() {
  return get_message_type_support_handle<task_2_interfaces::msg::JointData>();
}

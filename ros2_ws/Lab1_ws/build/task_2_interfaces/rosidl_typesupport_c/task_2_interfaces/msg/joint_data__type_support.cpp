...
static const _JointData_type_support_symbol_names_t _JointData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, task_2_interfaces, msg, JointData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, task_2_interfaces, msg, JointData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, task_2_interfaces, msg, JointData)() {
  return &::task_2_interfaces::msg::rosidl_typesupport_c::JointData_message_type_support_handle;
}
